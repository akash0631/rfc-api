FUNCTION ZWM_IROD_REV_PICK_TRANSFER.
*"--------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTINGsd
...
DATA:LT_NLPA TYPE LVS_BENUM.
LOOP AT LT_LTAP_CREATE2 ASSIGNING FIELD-SYMBOL(<lwa_ltap2>).

  <lwa_ltap2>-VLPLA = L_MBLNR.
      LT_NLPA              = <lwa_ltap2>-NLPLA.
