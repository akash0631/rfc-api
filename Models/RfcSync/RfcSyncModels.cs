...
namespace Vendor_SRM_Routing_Application.Models.RfcSync
{
    ...
    public class RfcUploadResponse
    {
        ...
        public string   ApiName        { get; set; }   // SAP RFC / API name
        public string   FileName       { get; set; }
        public long     FileSizeBytes  { get; set; }
        public DateTime UploadedAt     { get; set; }
        public string   Status         { get; set; }
        public string   DownloadUrl    { get; set; }   // relative URL to download the file
    }

    // ---- Document List (by API name) API ----------------------------------------
    public class RfcDocListItem
    {
        public int      UploadId       { get; set; }
        ...
        public DateTime UploadedAt     { get; set; }
        public string   Status         { get; set; }
        public string   DownloadUrl    { get; set; }   // relative URL to stream / download
    }

    public class RfcDocListResponse
    {
        public bool              Success   { get; set; }
        public string            Message   { get; set; }
        public string            ApiName   { get; set; }
        public int               TotalDocs { get; set; }
        public List<RfcDocListItem> Documents { get; set; }
    }
