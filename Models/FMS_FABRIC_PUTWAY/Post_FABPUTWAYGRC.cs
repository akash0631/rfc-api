...
namespace FMS_Fabric_Putway_Api.Models
{
    ...
    public class IT_TABLEPOST
    {
        ...
        public string GRC_NO { get; set; } = String.Empty;
        public string GR_LINE { get; set; } = String.Empty;
