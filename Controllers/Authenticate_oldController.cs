...
{
    public class Authenticate_oldController : BaseController
    {
        // [HttpPost]
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            for (int i = 0; i < IrfTable.RowCount; ++i)
                            {
                                ...
                                authenticateResponse.Site = IrfTable[i].GetString("WERKS");
                                //authenticateResponse.POQty = IrfTable[i].GetString("MENGE");
