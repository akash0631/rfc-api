...
{
    public class SRM_AutoUpdateController : ApiController
    {
            ...
            return await Task.Run(() =>
            {
                try
                {
                        ...
                        && request.Drive_Link != "" && request.Drive_Link != null)
                    {
                        ...
                        File.WriteAllText("D:\\V2 Published\\FMS_PUTWAY\\SRM_AutoUpdate.txt", createText);
        ...
        public async Task<HttpResponseMessage> GET()
        {
            ...
            try
            {
                ...
                var readText = File.ReadAllText("D:\\V2 Published\\FMS_PUTWAY\\SRM_AutoUpdate.txt").Split(',');
                    AutoupdateResponse AutoupdateResponse = new AutoupdateResponse();
