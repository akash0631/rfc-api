...
{
    public class ZWM_HUBWISE_STORE_LIST_RFCController : BaseController
    {
        [HttpPost]
        public async Task<HttpResponseMessage> Post([FromBody] ZWM_HUBWISE_STORE_LIST_RFCRequest request)
        {
            return await Task.Run(() =>
            {
                try
                {
                    ...
                    if (request.IM_USER != null)
                    {
                        ...
                        myfun = rfcrep.CreateFunction("ZWM_HUBWISE_STORE_LIST_RFC");
                        ...
                        else
                        {
                            ...
                            var etdata = IrfTable.AsEnumerable().Select(row => new
                            {
                                ...
                                HUB = row.GetString("HUB").ToString(),
                                GGROUP = row.GetString("GGROUP").ToString()
    ...
    public class ZWM_HUBWISE_STORE_LIST_RFCRequest
    {
