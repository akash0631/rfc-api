...
{
    public class DCRoutingAutoUpdateController : BaseController
    {
        ...
        public async Task<HttpResponseMessage> POST([FromBody] FMSAutoupdateRequest request)
        {
            ...
            try
            {
                    ...
                    && request.Drive_Link != "" && request.Drive_Link != null)
                {
                    ...
                    File.WriteAllText("D:\\V2 Published\\FMS_PUTWAY\\DCRouting_AutoUpdate.txt", createText);
        ...
        public async Task<HttpResponseMessage> GET()
        {
            ...
            try
            {
                ...
                var readText = File.ReadAllText("D:\\V2 Published\\FMS_PUTWAY\\DCRouting_AutoUpdate.txt").Split(',');
                //Development
