...
{
    public class HU_IdentifierAutoUpdateController : BaseController
    {
        ...
        public async Task<HttpResponseMessage> POST([FromBody] FMSAutoupdateRequest request)
        {
            ...
            try
            {
                    ...
                    && request.Drive_Link != "" && request.Drive_Link != null)
                {
                    ...
                    File.WriteAllText("D:\\V2 Published\\FMS_PUTWAY\\HU_IdentifierAutoUpdate.txt", createText);
        ...
        public async Task<HttpResponseMessage> GET()
        {
            ...
            try
            {
                ...
                var readText = File.ReadAllText("D:\\V2 Published\\FMS_PUTWAY\\HU_IdentifierAutoUpdate.txt").Split(',');
                //Development
                //var readText = File.ReadAllText("D:\\V2 Projects\\Vendor_SRM_Routing_Application\\FMS_AutoUpdate.txt").Split(',');
                FMSAutoupdateResponse AutoupdateResponse = new FMSAutoupdateResponse();
