...
{
    public class ZSALES_MOP_RFCController : BaseController
    {
        [HttpPost]
        public async Task<HttpResponseMessage> Post([FromBody] ZSALES_MOP_RFCRequest request)
        {
            return await Task.Run(() =>
            {
                try
                {
                    ...
                    if ( request.IM_DATE_HIGH != null)
                    {
                        ...
                        myfun = rfcrep.CreateFunction("ZSALES_MOP_RFC");

                        myfun.SetValue("IM_DATE_LOW", request.IM_DATE_LOW);
                        myfun.SetValue("IM_DATE_HIGH", request.IM_DATE_HIGH);
    ...
    public class ZSALES_MOP_RFCRequest
    {
        public string IM_DATE_LOW { get; set; }
        public string IM_DATE_HIGH { get; set; }
