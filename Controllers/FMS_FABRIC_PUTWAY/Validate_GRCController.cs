...
{
    public class Validate_GRCController : BaseController
    {
        // GET: HUNameCheck
        [b.HttpPost]
        public async Task<HttpResponseMessage> Post([FromBody] Validate_GRCRequest request)
        {
            return await Task.Run(() =>
            {
                try
                {
                        ...
                        )
                    {
                        ...
                        myfun = rfcrep.CreateFunction("ZFMS_RFC_FABPUTWAYGRC_VALIDATE"); //RfcFunctionName
