...
{
    public class ZWM_GATE_PALLATE_VALIDATE4_NController : BaseController
    {
        [HttpPost]
        public async Task<HttpResponseMessage> Post([FromBody] ZWM_GATE_PALLATE_VALIDATE4_NRequest request)
        {
            return await Task.Run(() =>
            {
                try
                {
                    ...
                    if (request.IM_PLANT != null)
                    {
                        ...
                        myfun = rfcrep.CreateFunction("ZWM_GATE_PALLATE_VALIDATE4_N");
                        ...
                        myfun.SetValue("IM_PALETTE", request.IM_PALETTE);
