...
{
    public class ZWM_GET_GATE_ENTRY_DATA_RFCController : BaseController
    {
        [HttpPost]
        public async Task<HttpResponseMessage> Post([FromBody] ZWM_GET_GATE_ENTRY_DATA_RFCRequest request)
        {
            return await Task.Run(() =>
            {
                try
                {
                    ...
                    if ( request.IM_WERKS != null)
                    {
                        ...
                        myfun = rfcrep.CreateFunction("ZWM_GET_GATE_ENTRY_DATA_RFC");
                        ...
                        else
                        {
                            ...
                            {
                                VPONO = row.GetString("VPONO").ToString(),
                                INVNO = row.GetString("INVNO").ToString()
    ...
    public class ZWM_GET_GATE_ENTRY_DATA_RFCRequest
    {
