...
{
    public class ZWM_GET_GATE_ENTRY_LIST4_RFCController : BaseController
    {
        [HttpPost]
        public async Task<HttpResponseMessage> Post([FromBody] ZWM_GET_GATE_ENTRY_LIST4_RFCRequest request)
        {
            return await Task.Run(() =>
            {
                try
                {
                    ...
                    if (request.IM_PLANT != null)
                    {
                        ...
                        myfun = rfcrep.CreateFunction("ZWM_GET_GATE_ENTRY_LIST4_RFC");
                        ...
                        else
                        {
                            ...
                            {
                                EDOCNO = row.GetString("EDOCNO").ToString()
    ...
    public class ZWM_GET_GATE_ENTRY_LIST4_RFCRequest
    {
