...
{
    public class ZWM_GATE_BOX3NController : BaseController
    {
        [HttpPost]
        public async Task<HttpResponseMessage> Post([FromBody] ZWM_GATE_BOX3NRequest request)
        {
            return await Task.Run(() =>
            {
                try
                {
                    ...
                    if ( request.IM_WERKS != null)
                    {
                        ...
                        myfun = rfcrep.CreateFunction("ZWM_GATE_BOX3N");
                        ...
                        myfun.SetValue("IM_BOX", request.IM_BOX);
                        myfun.SetValue("IM_WEIGHT", request.IM_WEIGHT);
