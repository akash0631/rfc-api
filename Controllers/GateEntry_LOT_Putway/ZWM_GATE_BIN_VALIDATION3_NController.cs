...
{
    public class ZWM_GATE_BIN_VALIDATION3_NController : BaseController
    {
        [HttpPost]
        public async Task<HttpResponseMessage> Post([FromBody] ZWM_GATE_BIN_VALIDATION3_NRequest request)
        {
            return await Task.Run(() =>
            {
                try
                {
                    ...
                    if ( request.IM_WERKS != null)
                    {
                        ...
                        myfun = rfcrep.CreateFunction("ZWM_GATE_BIN_VALIDATION3_N");
    ...
    public class ZWM_GATE_BIN_VALIDATION3_NRequest
    {
