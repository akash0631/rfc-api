...
{
    public class ZWM_GATE_BIN_VALIDATION4_NController : BaseController
    {
        [HttpPost]
        public async Task<HttpResponseMessage> Post([FromBody] ZWM_GATE_BIN_VALIDATION4_NRequest request)
        {
            return await Task.Run(() =>
            {
                try
                {
                    ...
                    if (request.IM_PLANT != null)
                    {
                        ...
                        myfun = rfcrep.CreateFunction("ZWM_GATE_BIN_VALIDATION4_N");
    ...
    public class ZWM_GATE_BIN_VALIDATION4_NRequest
    {
