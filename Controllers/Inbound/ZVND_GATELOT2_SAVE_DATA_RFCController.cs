...
{
    // HU Picking From BIN (GATELOT2) - Save Data RFC
    // Saves validated Palette/BIN/HU data to SAP after successful HU picking process
    public class ZVND_GATELOT2_SAVE_DATA_RFCController : BaseController
    {
        [HttpPost]
        [Route("api/ZVND_GATELOT2_SAVE_DATA_RFC")]
        public IHttpActionResult Post([FromBody] ZVND_GATELOT2_SAVE_Request request)
        {
            try
            {
                ...
                IRfcFunction myfun = dest.Repository.CreateFunction("ZVND_GATELOT2_SAVE_DATA_RFC");
    ...
    public class ZVND_GATELOT2_SAVE_Request
    {
