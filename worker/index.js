...
<head>
  ...
  <style>
    ...
    #swagger-ui .topbar{display:none;}
    .info-bar{background:#fff;border-bottom:2px solid var(--v2-accent);padding:10px 28px;font-size:13px;color:#555;display:flex;gap:24px;align-items:center;}
    .info-bar b{color:var(--v2-blue);}
    .nav-links{padding:10px 28px;background:#f0f4fa;border-bottom:1px solid #dde3ee;display:flex;gap:12px;font-size:13px;}
    .nav-links a{color:var(--v2-blue);text-decoration:none;padding:4px 10px;border-radius:4px;border:1px solid #c5d2e8;}
    .nav-links a:hover{background:var(--v2-blue);color:#fff;}
  </style>
</head>
<body>
<div id="topbar">
  <div class="logo">
    <div><div class="logo-text">V2 Retail</div><div class="logo-sub">Data Lake API</div></div>
  </div>
  <span class="badge">82 TABLES · LIVE</span>
</div>
<div class="nav-links">
  <a href="/explore">RFC Explorer</a>
  <a href="/sap-fetch">SAP Fetch UI</a>
  <a href="/data-lake">Data Lake (here)</a>
</div>
<div class="info-bar">
  <span>Source: <b>DataV2</b> @ 192.168.151.28</span>
  <span>Via: <b>Azure DAB</b> → my-dab-app.azurewebsites.net</span>
  <span>Auth: <b>None required</b></span>
  <span>Format: <b>OData REST</b></span>
</div>
<div id="swagger-ui"></div>
<script src="https://cdnjs.cloudflare.com/ajax/libs/swagger-ui/5.17.14/swagger-ui-bundle.js"></script>
<script>
const spec = {"openapi": "3.0.1", "info": {"title": "V2 Retail Data Lake", "description": "**82 tables** from DataV2 SQL Server (192.168.151.28).\n\nAll endpoints support OData query parameters.", "version": "1.0.0"}, "servers": [{"url": "https://my-dab-app.azurewebsites.net", "description": "Azure DAB \u2014 V2 Retail Data Lake"}], "paths": {"/api/API_Master_AKA": {"get": {"tags": ["API"], "summary": "API Master AKA", "description": "Table: `dbo.API_Master_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_API_Master_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/BIN_MOV_ART_WISE_AKA": {"get": {"tags": ["BIN"], "summary": "BIN MOV ART WISE AKA", "description": "Table: `dbo.BIN_MOV_ART_WISE_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_BIN_MOV_ART_WISE_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/BROADER_MENU": {"get": {"tags": ["BROADER"], "summary": "BROADER MENU", "description": "Table: `dbo.BROADER_MENU` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_BROADER_MENU", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/COMPANY_STOCK_GEN_ART_CLR_MASTER_AKA": {"get": {"tags": ["COMPANY"], "summary": "COMPANY STOCK GEN ART CLR MASTER AKA", "description": "Table: `dbo.COMPANY_STOCK_GEN_ART_CLR_MASTER_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_COMPANY_STOCK_GEN_ART_CLR_MASTER_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/COMPANY_STOCK_MASTER_AKA": {"get": {"tags": ["COMPANY"], "summary": "COMPANY STOCK MASTER AKA", "description": "Table: `dbo.COMPANY_STOCK_MASTER_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_COMPANY_STOCK_MASTER_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/CO_BGT_AK_CO_MJ_ALL_BGT": {"get": {"tags": ["CO"], "summary": "CO BGT AK CO MJ ALL BGT", "description": "Table: `dbo.CO_BGT_AK_CO_MJ_ALL_BGT` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_CO_BGT_AK_CO_MJ_ALL_BGT", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/CO_BGT_AK_CO_MJ_CLR_ALL_BGT": {"get": {"tags": ["CO"], "summary": "CO BGT AK CO MJ CLR ALL BGT", "description": "Table: `dbo.CO_BGT_AK_CO_MJ_CLR_ALL_BGT` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_CO_BGT_AK_CO_MJ_CLR_ALL_BGT", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/CO_BGT_AK_CO_MJ_FAB_ALL_BGT_AKA": {"get": {"tags": ["CO"], "summary": "CO BGT AK CO MJ FAB ALL BGT AKA", "description": "Table: `dbo.CO_BGT_AK_CO_MJ_FAB_ALL_BGT_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_CO_BGT_AK_CO_MJ_FAB_ALL_BGT_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/CO_BGT_AK_CO_MJ_M_MVGR_ALL_BGT_AKA": {"get": {"tags": ["CO"], "summary": "CO BGT AK CO MJ M MVGR ALL BGT AKA", "description": "Table: `dbo.CO_BGT_AK_CO_MJ_M_MVGR_ALL_BGT_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_CO_BGT_AK_CO_MJ_M_MVGR_ALL_BGT_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/CO_BGT_AK_CO_MJ_SZ_ALL_BGT": {"get": {"tags": ["CO"], "summary": "CO BGT AK CO MJ SZ ALL BGT", "description": "Table: `dbo.CO_BGT_AK_CO_MJ_SZ_ALL_BGT` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_CO_BGT_AK_CO_MJ_SZ_ALL_BGT", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/CO_BGT_AK_CO_MJ_VND_ALL_BGT_AKA": {"get": {"tags": ["CO"], "summary": "CO BGT AK CO MJ VND ALL BGT AKA", "description": "Table: `dbo.CO_BGT_AK_CO_MJ_VND_ALL_BGT_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_CO_BGT_AK_CO_MJ_VND_ALL_BGT_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/CO_BGT_AK_ST_MJ_ALL_BGT": {"get": {"tags": ["CO"], "summary": "CO BGT AK ST MJ ALL BGT", "description": "Table: `dbo.CO_BGT_AK_ST_MJ_ALL_BGT` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_CO_BGT_AK_ST_MJ_ALL_BGT", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/CO_BGT_AK_ST_MJ_CLR_ALL_BGT": {"get": {"tags": ["CO"], "summary": "CO BGT AK ST MJ CLR ALL BGT", "description": "Table: `dbo.CO_BGT_AK_ST_MJ_CLR_ALL_BGT` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_CO_BGT_AK_ST_MJ_CLR_ALL_BGT", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/CO_BGT_AK_ST_MJ_SZ_ALL_BGT": {"get": {"tags": ["CO"], "summary": "CO BGT AK ST MJ SZ ALL BGT", "description": "Table: `dbo.CO_BGT_AK_ST_MJ_SZ_ALL_BGT` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_CO_BGT_AK_ST_MJ_SZ_ALL_BGT", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/C_ART_DATA": {"get": {"tags": ["C"], "summary": "C ART DATA", "description": "Table: `dbo.C_ART_DATA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_C_ART_DATA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/DAILY_SALE_DATA_GEN_ART_WISE": {"get": {"tags": ["DAILY"], "summary": "DAILY SALE DATA GEN ART WISE", "description": "Table: `dbo.DAILY_SALE_DATA_GEN_ART_WISE` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_DAILY_SALE_DATA_GEN_ART_WISE", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/DAILY_SALE_DATA_GEN_CLR_WISE": {"get": {"tags": ["DAILY"], "summary": "DAILY SALE DATA GEN CLR WISE", "description": "Table: `dbo.DAILY_SALE_DATA_GEN_CLR_WISE` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_DAILY_SALE_DATA_GEN_CLR_WISE", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ET_ ZADVANCE_PAYMENT": {"get": {"tags": ["ET"], "summary": "ET  ZADVANCE PAYMENT", "description": "Table: `dbo.ET_ ZADVANCE_PAYMENT` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ET_ ZADVANCE_PAYMENT", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ET_ADVANCE_PAYMENT": {"get": {"tags": ["ET"], "summary": "ET ADVANCE PAYMENT", "description": "Table: `dbo.ET_ADVANCE_PAYMENT` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ET_ADVANCE_PAYMENT", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ET_ARTICLE_GEN_CLR_WISE": {"get": {"tags": ["ET"], "summary": "ET ARTICLE GEN CLR WISE", "description": "Table: `dbo.ET_ARTICLE_GEN_CLR_WISE` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ET_ARTICLE_GEN_CLR_WISE", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ET_ART_Broader_Menu_DATA": {"get": {"tags": ["ET"], "summary": "ET ART Broader Menu DATA", "description": "Table: `dbo.ET_ART_Broader_Menu_DATA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ET_ART_Broader_Menu_DATA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ET_FINANCE_DOCUMENTS": {"get": {"tags": ["ET"], "summary": "ET FINANCE DOCUMENTS", "description": "Table: `dbo.ET_FINANCE_DOCUMENTS` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ET_FINANCE_DOCUMENTS", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ET_GENERATED": {"get": {"tags": ["ET"], "summary": "ET GENERATED", "description": "Table: `dbo.ET_GENERATED` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ET_GENERATED", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ET_PROJECT_OVERVIEW": {"get": {"tags": ["ET"], "summary": "ET PROJECT OVERVIEW", "description": "Table: `dbo.ET_PROJECT_OVERVIEW` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ET_PROJECT_OVERVIEW", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ET_PUR_DATA_RPT_AKA": {"get": {"tags": ["ET"], "summary": "ET PUR DATA RPT AKA", "description": "Table: `dbo.ET_PUR_DATA_RPT_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ET_PUR_DATA_RPT_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ET_SALES_DATA": {"get": {"tags": ["ET"], "summary": "ET SALES DATA", "description": "Table: `dbo.ET_SALES_DATA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ET_SALES_DATA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ET_Supplier_Master": {"get": {"tags": ["ET"], "summary": "ET Supplier Master", "description": "Table: `dbo.ET_Supplier_Master` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ET_Supplier_Master", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ET_VARIANT_ART_WISE": {"get": {"tags": ["ET"], "summary": "ET VARIANT ART WISE", "description": "Table: `dbo.ET_VARIANT_ART_WISE` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ET_VARIANT_ART_WISE", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ET_VEND_DEDUCTION": {"get": {"tags": ["ET"], "summary": "ET VEND DEDUCTION", "description": "Table: `dbo.ET_VEND_DEDUCTION` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ET_VEND_DEDUCTION", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ET_VEND_DEDUCTION_AKA": {"get": {"tags": ["ET"], "summary": "ET VEND DEDUCTION AKA", "description": "Table: `dbo.ET_VEND_DEDUCTION_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ET_VEND_DEDUCTION_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ET_VEND_PAY": {"get": {"tags": ["ET"], "summary": "ET VEND PAY", "description": "Table: `dbo.ET_VEND_PAY` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ET_VEND_PAY", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ET_ZADVANCE_PAYMENT": {"get": {"tags": ["ET"], "summary": "ET ZADVANCE PAYMENT", "description": "Table: `dbo.ET_ZADVANCE_PAYMENT` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ET_ZADVANCE_PAYMENT", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ET_ZART_BAR_DETAIL_RFC": {"get": {"tags": ["ET"], "summary": "ET ZART BAR DETAIL RFC", "description": "Table: `dbo.ET_ZART_BAR_DETAIL_RFC` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ET_ZART_BAR_DETAIL_RFC", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ET_ZFBL1N_PAYMENT_RFC": {"get": {"tags": ["ET"], "summary": "ET ZFBL1N PAYMENT RFC", "description": "Table: `dbo.ET_ZFBL1N_PAYMENT_RFC` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ET_ZFBL1N_PAYMENT_RFC", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ET_ZFI_FB65_DISCOUNT_RFC": {"get": {"tags": ["ET"], "summary": "ET ZFI FB65 DISCOUNT RFC", "description": "Table: `dbo.ET_ZFI_FB65_DISCOUNT_RFC` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ET_ZFI_FB65_DISCOUNT_RFC", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ET_ZGET_STORE_MASTER": {"get": {"tags": ["ET"], "summary": "ET ZGET STORE MASTER", "description": "Table: `dbo.ET_ZGET_STORE_MASTER` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ET_ZGET_STORE_MASTER", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ET_ZMC_SIZE_MASTER_RFC": {"get": {"tags": ["ET"], "summary": "ET ZMC SIZE MASTER RFC", "description": "Table: `dbo.ET_ZMC_SIZE_MASTER_RFC` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ET_ZMC_SIZE_MASTER_RFC", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ET_ZMM_CITY_TRNS_RFC": {"get": {"tags": ["ET"], "summary": "ET ZMM CITY TRNS RFC", "description": "Table: `dbo.ET_ZMM_CITY_TRNS_RFC` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ET_ZMM_CITY_TRNS_RFC", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ET_ZPO_MODIFICATION": {"get": {"tags": ["ET"], "summary": "ET ZPO MODIFICATION", "description": "Table: `dbo.ET_ZPO_MODIFICATION` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ET_ZPO_MODIFICATION", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ET_ZPO_MODIFICATION_RFC_AKA": {"get": {"tags": ["ET"], "summary": "ET ZPO MODIFICATION RFC AKA", "description": "Table: `dbo.ET_ZPO_MODIFICATION_RFC_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ET_ZPO_MODIFICATION_RFC_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ET_ZPO_MODIFY_REASON": {"get": {"tags": ["ET"], "summary": "ET ZPO MODIFY REASON", "description": "Table: `dbo.ET_ZPO_MODIFY_REASON` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ET_ZPO_MODIFY_REASON", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ET_ZSRM_ROUTING_LOG_RFC": {"get": {"tags": ["ET"], "summary": "ET ZSRM ROUTING LOG RFC", "description": "Table: `dbo.ET_ZSRM_ROUTING_LOG_RFC` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ET_ZSRM_ROUTING_LOG_RFC", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ET_ZTEST": {"get": {"tags": ["ET"], "summary": "ET ZTEST", "description": "Table: `dbo.ET_ZTEST` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ET_ZTEST", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/GET_VV_ART_DATA_AKA": {"get": {"tags": ["GET"], "summary": "GET VV ART DATA AKA", "description": "Table: `dbo.GET_VV_ART_DATA_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_GET_VV_ART_DATA_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/HHT_VERIENT_ART": {"get": {"tags": ["HHT"], "summary": "HHT VERIENT ART", "description": "Table: `dbo.HHT_VERIENT_ART` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_HHT_VERIENT_ART", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/INVT_DC_MJ_AKA": {"get": {"tags": ["INVT"], "summary": "INVT DC MJ AKA", "description": "Table: `dbo.INVT_DC_MJ_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_INVT_DC_MJ_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/INVT_DC_MJ_CAT_VND_AKA": {"get": {"tags": ["INVT"], "summary": "INVT DC MJ CAT VND AKA", "description": "Table: `dbo.INVT_DC_MJ_CAT_VND_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_INVT_DC_MJ_CAT_VND_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/INVT_ST_MJ_CAT_AKA": {"get": {"tags": ["INVT"], "summary": "INVT ST MJ CAT AKA", "description": "Table: `dbo.INVT_ST_MJ_CAT_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_INVT_ST_MJ_CAT_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/INVT_ST_MJ_CAT_CLR_AKA": {"get": {"tags": ["INVT"], "summary": "INVT ST MJ CAT CLR AKA", "description": "Table: `dbo.INVT_ST_MJ_CAT_CLR_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_INVT_ST_MJ_CAT_CLR_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/INVT_ST_MJ_CAT_FAB_AKA": {"get": {"tags": ["INVT"], "summary": "INVT ST MJ CAT FAB AKA", "description": "Table: `dbo.INVT_ST_MJ_CAT_FAB_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_INVT_ST_MJ_CAT_FAB_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/INVT_ST_MJ_CAT_MACRO_MVGR_AKA": {"get": {"tags": ["INVT"], "summary": "INVT ST MJ CAT MACRO MVGR AKA", "description": "Table: `dbo.INVT_ST_MJ_CAT_MACRO_MVGR_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_INVT_ST_MJ_CAT_MACRO_MVGR_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/INVT_ST_MJ_CAT_MICRO_MVGR_AKA": {"get": {"tags": ["INVT"], "summary": "INVT ST MJ CAT MICRO MVGR AKA", "description": "Table: `dbo.INVT_ST_MJ_CAT_MICRO_MVGR_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_INVT_ST_MJ_CAT_MICRO_MVGR_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/INVT_ST_MJ_CAT_MRP_AKA": {"get": {"tags": ["INVT"], "summary": "INVT ST MJ CAT MRP AKA", "description": "Table: `dbo.INVT_ST_MJ_CAT_MRP_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_INVT_ST_MJ_CAT_MRP_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/INVT_ST_MJ_CAT_RNG_SEG_AKA": {"get": {"tags": ["INVT"], "summary": "INVT ST MJ CAT RNG SEG AKA", "description": "Table: `dbo.INVT_ST_MJ_CAT_RNG_SEG_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_INVT_ST_MJ_CAT_RNG_SEG_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/INVT_ST_MJ_CAT_SIZE_AKA": {"get": {"tags": ["INVT"], "summary": "INVT ST MJ CAT SIZE AKA", "description": "Table: `dbo.INVT_ST_MJ_CAT_SIZE_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_INVT_ST_MJ_CAT_SIZE_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/INVT_ST_MJ_CAT_VND_AKA": {"get": {"tags": ["INVT"], "summary": "INVT ST MJ CAT VND AKA", "description": "Table: `dbo.INVT_ST_MJ_CAT_VND_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_INVT_ST_MJ_CAT_VND_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/Issue_Tracker": {"get": {"tags": ["Issue"], "summary": "Issue Tracker", "description": "Table: `dbo.Issue_Tracker` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_Issue_Tracker", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/Karma_Detailed_Report": {"get": {"tags": ["Karma"], "summary": "Karma Detailed Report", "description": "Table: `dbo.Karma_Detailed_Report` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_Karma_Detailed_Report", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/Karma_Summary_Report": {"get": {"tags": ["Karma"], "summary": "Karma Summary Report", "description": "Table: `dbo.Karma_Summary_Report` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_Karma_Summary_Report", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/L_ARTICLE_Sheet1": {"get": {"tags": ["L"], "summary": "L ARTICLE Sheet1", "description": "Table: `dbo.L_ARTICLE_Sheet1` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_L_ARTICLE_Sheet1", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/MRDC_VAR_ART_AKA": {"get": {"tags": ["MRDC"], "summary": "MRDC VAR ART AKA", "description": "Table: `dbo.MRDC_VAR_ART_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_MRDC_VAR_ART_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/MSA_STOCK_DATA_AKA": {"get": {"tags": ["MSA"], "summary": "MSA STOCK DATA AKA", "description": "Table: `dbo.MSA_STOCK_DATA_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_MSA_STOCK_DATA_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/PO_DATA_AKA": {"get": {"tags": ["PO"], "summary": "PO DATA AKA", "description": "Table: `dbo.PO_DATA_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_PO_DATA_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/Product_Master": {"get": {"tags": ["Product"], "summary": "Product Master", "description": "Table: `dbo.Product_Master` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_Product_Master", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/RETAIL_BAR_CODE_AKA": {"get": {"tags": ["RETAIL"], "summary": "RETAIL BAR CODE AKA", "description": "Table: `dbo.RETAIL_BAR_CODE_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_RETAIL_BAR_CODE_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ROI_TREND_DATA_AKA": {"get": {"tags": ["ROI"], "summary": "ROI TREND DATA AKA", "description": "Table: `dbo.ROI_TREND_DATA_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ROI_TREND_DATA_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/SALE_DATA_CM_AKA": {"get": {"tags": ["SALE"], "summary": "SALE DATA CM AKA", "description": "Table: `dbo.SALE_DATA_CM_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_SALE_DATA_CM_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/SALE_DATA_L_2_YEAR_MONTH_AKA": {"get": {"tags": ["SALE"], "summary": "SALE DATA L 2 YEAR MONTH AKA", "description": "Table: `dbo.SALE_DATA_L_2_YEAR_MONTH_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_SALE_DATA_L_2_YEAR_MONTH_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/STORE_MAJ_CAT_BUDGET_FIXTURE_AKA": {"get": {"tags": ["STORE"], "summary": "STORE MAJ CAT BUDGET FIXTURE AKA", "description": "Table: `dbo.STORE_MAJ_CAT_BUDGET_FIXTURE_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_STORE_MAJ_CAT_BUDGET_FIXTURE_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/STORE_PLANT_MASTER_AKA": {"get": {"tags": ["STORE"], "summary": "STORE PLANT MASTER AKA", "description": "Table: `dbo.STORE_PLANT_MASTER_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_STORE_PLANT_MASTER_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/Sale_Data_L_2Years_MAJ_CAT_aka": {"get": {"tags": ["Sale"], "summary": "Sale Data L 2Years MAJ CAT aka", "description": "Table: `dbo.Sale_Data_L_2Years_MAJ_CAT_aka` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_Sale_Data_L_2Years_MAJ_CAT_aka", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/Sale_Data_L_2Years_STORE_aka": {"get": {"tags": ["Sale"], "summary": "Sale Data L 2Years STORE aka", "description": "Table: `dbo.Sale_Data_L_2Years_STORE_aka` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_Sale_Data_L_2Years_STORE_aka", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/TBL_16_RETAIL_GND_BGT_FORMAT_Sheet1": {"get": {"tags": ["TBL"], "summary": "TBL 16 RETAIL GND BGT FORMAT Sheet1", "description": "Table: `dbo.TBL_16_RETAIL_GND_BGT_FORMAT_Sheet1` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_TBL_16_RETAIL_GND_BGT_FORMAT_Sheet1", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/TNA_REPORT": {"get": {"tags": ["TNA"], "summary": "TNA REPORT", "description": "Table: `dbo.TNA_REPORT` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_TNA_REPORT", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/Task_Tracker": {"get": {"tags": ["Task"], "summary": "Task Tracker", "description": "Table: `dbo.Task_Tracker` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_Task_Tracker", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/VIEW_SALE_GEN_CLR_ART_WISE": {"get": {"tags": ["VIEW"], "summary": "VIEW SALE GEN CLR ART WISE", "description": "Table: `dbo.VIEW_SALE_GEN_CLR_ART_WISE` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_VIEW_SALE_GEN_CLR_ART_WISE", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/VW_ET_SALES_DATA_AKA": {"get": {"tags": ["VW"], "summary": "VW ET SALES DATA AKA", "description": "Table: `dbo.VW_ET_SALES_DATA_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_VW_ET_SALES_DATA_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/VW_GRC_REPORT_AKA": {"get": {"tags": ["VW"], "summary": "VW GRC REPORT AKA", "description": "Table: `dbo.VW_GRC_REPORT_AKA` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_VW_GRC_REPORT_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/VW_GRC_REPORT_NEW": {"get": {"tags": ["VW"], "summary": "VW GRC REPORT NEW", "description": "Table: `dbo.VW_GRC_REPORT_NEW` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_VW_GRC_REPORT_NEW", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/VW_LYSP_DAY_MAPPING": {"get": {"tags": ["VW"], "summary": "VW LYSP DAY MAPPING", "description": "Table: `dbo.VW_LYSP_DAY_MAPPING` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_VW_LYSP_DAY_MAPPING", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/ZSRM_VEND_PAYMENT_INFO": {"get": {"tags": ["ZSRM"], "summary": "ZSRM VEND PAYMENT INFO", "description": "Table: `dbo.ZSRM_VEND_PAYMENT_INFO` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_ZSRM_VEND_PAYMENT_INFO", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}, "/api/vw_PO_PENDING_New": {"get": {"tags": ["vw"], "summary": "vw PO PENDING New", "description": "Table: `dbo.vw_PO_PENDING_New` \u2014 OData: `$filter`, `$orderby`, `$top`, `$skip`, `$select`", "operationId": "get_vw_PO_PENDING_New", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "e.g. `STORE_CODE eq 'DL01'`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}}, {"name": "$select", "in": "query", "schema": {"type": "string"}}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}}], "responses": {"200": {"description": "Success", "content": {"application/json": {"schema": {"type": "object"}}}}}}}}};
SwaggerUIBundle({
  spec,
  dom_id: '#swagger-ui',
  deepLinking: true,
