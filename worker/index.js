...
<head>
  ...
  <title>V2 Retail Data Lake — API Docs</title>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/swagger-ui/5.11.0/swagger-ui.min.css">
  <style>
    body { margin: 0; background: #f4f6fb; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; }
    #topbar { background: #1a1f36; padding: 14px 24px; display: flex; align-items: center; gap: 16px; }
    #topbar h1 { color: #fff; font-size: 18px; font-weight: 600; margin: 0; }
    #topbar span { color: #8892b0; font-size: 13px; }
    #topbar a { color: #64d2ff; font-size: 13px; text-decoration: none; margin-left: auto; }
    #topbar a:hover { text-decoration: underline; }
    #swagger-ui .topbar { display: none; }
    #swagger-ui { max-width: 1200px; margin: 0 auto; padding: 24px; }
    .filter-bar { max-width: 1200px; margin: 0 auto; padding: 12px 24px 0; }
    .filter-bar input { width: 100%; padding: 10px 16px; border: 1px solid #dde1ef; border-radius: 8px; font-size: 14px; box-sizing: border-box; background: #fff; box-shadow: 0 1px 4px rgba(0,0,0,.06); }
    .filter-bar input:focus { outline: none; border-color: #0066cc; box-shadow: 0 0 0 3px rgba(0,102,204,.12); }
  </style>
</head>
<body>
  <div id="topbar">
    <h1>⚡ V2 Retail Data Lake</h1>
    <span>81 tables · Azure DAB · OData filtering</span>
    <a href="/explore">← RFC Explorer</a>
    <a href="/sap-fetch">SAP Fetch →</a>
  </div>
  <div class="filter-bar">
    <input type="text" id="filterInput" placeholder="🔍 Filter APIs... e.g. SALES, INVT, PO, VEND" oninput="filterAPIs(this.value)">
  </div>
  <div id="swagger-ui"></div>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/swagger-ui/5.11.0/swagger-ui-bundle.min.js"></script>
  <script>
    const spec = {"openapi": "3.0.0", "info": {"title": "V2 Retail Data Lake API", "version": "1.0.0", "description": "81 Data Lake tables via Azure DAB (Data API Builder). Base URL: https://my-dab-app.azurewebsites.net"}, "servers": [{"url": "https://my-dab-app.azurewebsites.net", "description": "Azure DAB \u2014 Data Lake"}], "paths": {"/api/API_Master_AKA": {"get": {"tags": ["API_Master_AKA"], "summary": "Query API_Master_AKA", "description": "GET rows from Data Lake table API_Master_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_API_Master_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/BIN_MOV_ART_WISE_AKA": {"get": {"tags": ["BIN_MOV_ART_WISE_AKA"], "summary": "Query BIN_MOV_ART_WISE_AKA", "description": "GET rows from Data Lake table BIN_MOV_ART_WISE_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_BIN_MOV_ART_WISE_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/BROADER_MENU": {"get": {"tags": ["BROADER_MENU"], "summary": "Query BROADER_MENU", "description": "GET rows from Data Lake table BROADER_MENU. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_BROADER_MENU", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/COMPANY_STOCK_GEN_ART_CLR_MASTER_AKA": {"get": {"tags": ["COMPANY_STOCK_GEN_ART_CLR_MASTER_AKA"], "summary": "Query COMPANY_STOCK_GEN_ART_CLR_MASTER_AKA", "description": "GET rows from Data Lake table COMPANY_STOCK_GEN_ART_CLR_MASTER_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_COMPANY_STOCK_GEN_ART_CLR_MASTER_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/COMPANY_STOCK_MASTER_AKA": {"get": {"tags": ["COMPANY_STOCK_MASTER_AKA"], "summary": "Query COMPANY_STOCK_MASTER_AKA", "description": "GET rows from Data Lake table COMPANY_STOCK_MASTER_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_COMPANY_STOCK_MASTER_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/CO_BGT_AK_CO_MJ_ALL_BGT": {"get": {"tags": ["CO_BGT_AK_CO_MJ_ALL_BGT"], "summary": "Query CO_BGT_AK_CO_MJ_ALL_BGT", "description": "GET rows from Data Lake table CO_BGT_AK_CO_MJ_ALL_BGT. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_CO_BGT_AK_CO_MJ_ALL_BGT", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/CO_BGT_AK_CO_MJ_CLR_ALL_BGT": {"get": {"tags": ["CO_BGT_AK_CO_MJ_CLR_ALL_BGT"], "summary": "Query CO_BGT_AK_CO_MJ_CLR_ALL_BGT", "description": "GET rows from Data Lake table CO_BGT_AK_CO_MJ_CLR_ALL_BGT. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_CO_BGT_AK_CO_MJ_CLR_ALL_BGT", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/CO_BGT_AK_CO_MJ_FAB_ALL_BGT_AKA": {"get": {"tags": ["CO_BGT_AK_CO_MJ_FAB_ALL_BGT_AKA"], "summary": "Query CO_BGT_AK_CO_MJ_FAB_ALL_BGT_AKA", "description": "GET rows from Data Lake table CO_BGT_AK_CO_MJ_FAB_ALL_BGT_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_CO_BGT_AK_CO_MJ_FAB_ALL_BGT_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/CO_BGT_AK_CO_MJ_M_MVGR_ALL_BGT_AKA": {"get": {"tags": ["CO_BGT_AK_CO_MJ_M_MVGR_ALL_BGT_AKA"], "summary": "Query CO_BGT_AK_CO_MJ_M_MVGR_ALL_BGT_AKA", "description": "GET rows from Data Lake table CO_BGT_AK_CO_MJ_M_MVGR_ALL_BGT_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_CO_BGT_AK_CO_MJ_M_MVGR_ALL_BGT_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/CO_BGT_AK_CO_MJ_SZ_ALL_BGT": {"get": {"tags": ["CO_BGT_AK_CO_MJ_SZ_ALL_BGT"], "summary": "Query CO_BGT_AK_CO_MJ_SZ_ALL_BGT", "description": "GET rows from Data Lake table CO_BGT_AK_CO_MJ_SZ_ALL_BGT. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_CO_BGT_AK_CO_MJ_SZ_ALL_BGT", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/CO_BGT_AK_CO_MJ_VND_ALL_BGT_AKA": {"get": {"tags": ["CO_BGT_AK_CO_MJ_VND_ALL_BGT_AKA"], "summary": "Query CO_BGT_AK_CO_MJ_VND_ALL_BGT_AKA", "description": "GET rows from Data Lake table CO_BGT_AK_CO_MJ_VND_ALL_BGT_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_CO_BGT_AK_CO_MJ_VND_ALL_BGT_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/CO_BGT_AK_ST_MJ_ALL_BGT": {"get": {"tags": ["CO_BGT_AK_ST_MJ_ALL_BGT"], "summary": "Query CO_BGT_AK_ST_MJ_ALL_BGT", "description": "GET rows from Data Lake table CO_BGT_AK_ST_MJ_ALL_BGT. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_CO_BGT_AK_ST_MJ_ALL_BGT", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/CO_BGT_AK_ST_MJ_CLR_ALL_BGT": {"get": {"tags": ["CO_BGT_AK_ST_MJ_CLR_ALL_BGT"], "summary": "Query CO_BGT_AK_ST_MJ_CLR_ALL_BGT", "description": "GET rows from Data Lake table CO_BGT_AK_ST_MJ_CLR_ALL_BGT. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_CO_BGT_AK_ST_MJ_CLR_ALL_BGT", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/CO_BGT_AK_ST_MJ_SZ_ALL_BGT": {"get": {"tags": ["CO_BGT_AK_ST_MJ_SZ_ALL_BGT"], "summary": "Query CO_BGT_AK_ST_MJ_SZ_ALL_BGT", "description": "GET rows from Data Lake table CO_BGT_AK_ST_MJ_SZ_ALL_BGT. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_CO_BGT_AK_ST_MJ_SZ_ALL_BGT", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/C_ART_DATA": {"get": {"tags": ["C_ART_DATA"], "summary": "Query C_ART_DATA", "description": "GET rows from Data Lake table C_ART_DATA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_C_ART_DATA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/DAILY_SALE_DATA_GEN_ART_WISE": {"get": {"tags": ["DAILY_SALE_DATA_GEN_ART_WISE"], "summary": "Query DAILY_SALE_DATA_GEN_ART_WISE", "description": "GET rows from Data Lake table DAILY_SALE_DATA_GEN_ART_WISE. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_DAILY_SALE_DATA_GEN_ART_WISE", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/DAILY_SALE_DATA_GEN_CLR_WISE": {"get": {"tags": ["DAILY_SALE_DATA_GEN_CLR_WISE"], "summary": "Query DAILY_SALE_DATA_GEN_CLR_WISE", "description": "GET rows from Data Lake table DAILY_SALE_DATA_GEN_CLR_WISE. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_DAILY_SALE_DATA_GEN_CLR_WISE", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ET_ARTICLE_GEN_CLR_WISE": {"get": {"tags": ["ET_ARTICLE_GEN_CLR_WISE"], "summary": "Query ET_ARTICLE_GEN_CLR_WISE", "description": "GET rows from Data Lake table ET_ARTICLE_GEN_CLR_WISE. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ET_ARTICLE_GEN_CLR_WISE", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ET_ART_Broader_Menu_DATA": {"get": {"tags": ["ET_ART_Broader_Menu_DATA"], "summary": "Query ET_ART_Broader_Menu_DATA", "description": "GET rows from Data Lake table ET_ART_Broader_Menu_DATA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ET_ART_Broader_Menu_DATA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ET_PUR_DATA_RPT_AKA": {"get": {"tags": ["ET_PUR_DATA_RPT_AKA"], "summary": "Query ET_PUR_DATA_RPT_AKA", "description": "GET rows from Data Lake table ET_PUR_DATA_RPT_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ET_PUR_DATA_RPT_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ET_SALES_DATA": {"get": {"tags": ["ET_SALES_DATA"], "summary": "Query ET_SALES_DATA", "description": "GET rows from Data Lake table ET_SALES_DATA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ET_SALES_DATA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ET_Supplier_Master": {"get": {"tags": ["ET_Supplier_Master"], "summary": "Query ET_Supplier_Master", "description": "GET rows from Data Lake table ET_Supplier_Master. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ET_Supplier_Master", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ET_VARIANT_ART_WISE": {"get": {"tags": ["ET_VARIANT_ART_WISE"], "summary": "Query ET_VARIANT_ART_WISE", "description": "GET rows from Data Lake table ET_VARIANT_ART_WISE. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ET_VARIANT_ART_WISE", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ET_VEND_DEDUCTION": {"get": {"tags": ["ET_VEND_DEDUCTION"], "summary": "Query ET_VEND_DEDUCTION", "description": "GET rows from Data Lake table ET_VEND_DEDUCTION. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ET_VEND_DEDUCTION", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ET_VEND_DEDUCTION_AKA": {"get": {"tags": ["ET_VEND_DEDUCTION_AKA"], "summary": "Query ET_VEND_DEDUCTION_AKA", "description": "GET rows from Data Lake table ET_VEND_DEDUCTION_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ET_VEND_DEDUCTION_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ET_VEND_PAY": {"get": {"tags": ["ET_VEND_PAY"], "summary": "Query ET_VEND_PAY", "description": "GET rows from Data Lake table ET_VEND_PAY. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ET_VEND_PAY", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ET_ZART_BAR_DETAIL_RFC": {"get": {"tags": ["ET_ZART_BAR_DETAIL_RFC"], "summary": "Query ET_ZART_BAR_DETAIL_RFC", "description": "GET rows from Data Lake table ET_ZART_BAR_DETAIL_RFC. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ET_ZART_BAR_DETAIL_RFC", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ET_ZFBL1N_PAYMENT_RFC": {"get": {"tags": ["ET_ZFBL1N_PAYMENT_RFC"], "summary": "Query ET_ZFBL1N_PAYMENT_RFC", "description": "GET rows from Data Lake table ET_ZFBL1N_PAYMENT_RFC. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ET_ZFBL1N_PAYMENT_RFC", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ET_ZFI_FB65_DISCOUNT_RFC": {"get": {"tags": ["ET_ZFI_FB65_DISCOUNT_RFC"], "summary": "Query ET_ZFI_FB65_DISCOUNT_RFC", "description": "GET rows from Data Lake table ET_ZFI_FB65_DISCOUNT_RFC. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ET_ZFI_FB65_DISCOUNT_RFC", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ET_ZMC_SIZE_MASTER_RFC": {"get": {"tags": ["ET_ZMC_SIZE_MASTER_RFC"], "summary": "Query ET_ZMC_SIZE_MASTER_RFC", "description": "GET rows from Data Lake table ET_ZMC_SIZE_MASTER_RFC. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ET_ZMC_SIZE_MASTER_RFC", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ET_ZMM_CITY_TRNS_RFC": {"get": {"tags": ["ET_ZMM_CITY_TRNS_RFC"], "summary": "Query ET_ZMM_CITY_TRNS_RFC", "description": "GET rows from Data Lake table ET_ZMM_CITY_TRNS_RFC. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ET_ZMM_CITY_TRNS_RFC", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ET_ZPO_MODIFICATION": {"get": {"tags": ["ET_ZPO_MODIFICATION"], "summary": "Query ET_ZPO_MODIFICATION", "description": "GET rows from Data Lake table ET_ZPO_MODIFICATION. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ET_ZPO_MODIFICATION", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ET_ZPO_MODIFICATION_RFC_AKA": {"get": {"tags": ["ET_ZPO_MODIFICATION_RFC_AKA"], "summary": "Query ET_ZPO_MODIFICATION_RFC_AKA", "description": "GET rows from Data Lake table ET_ZPO_MODIFICATION_RFC_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ET_ZPO_MODIFICATION_RFC_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ET_ZPO_MODIFY_REASON": {"get": {"tags": ["ET_ZPO_MODIFY_REASON"], "summary": "Query ET_ZPO_MODIFY_REASON", "description": "GET rows from Data Lake table ET_ZPO_MODIFY_REASON. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ET_ZPO_MODIFY_REASON", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ET_ZSRM_ROUTING_LOG_RFC": {"get": {"tags": ["ET_ZSRM_ROUTING_LOG_RFC"], "summary": "Query ET_ZSRM_ROUTING_LOG_RFC", "description": "GET rows from Data Lake table ET_ZSRM_ROUTING_LOG_RFC. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ET_ZSRM_ROUTING_LOG_RFC", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/GET_VV_ART_DATA_AKA": {"get": {"tags": ["GET_VV_ART_DATA_AKA"], "summary": "Query GET_VV_ART_DATA_AKA", "description": "GET rows from Data Lake table GET_VV_ART_DATA_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_GET_VV_ART_DATA_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/HHT_VERIENT_ART": {"get": {"tags": ["HHT_VERIENT_ART"], "summary": "Query HHT_VERIENT_ART", "description": "GET rows from Data Lake table HHT_VERIENT_ART. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_HHT_VERIENT_ART", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/INVT_DC_MJ_AKA": {"get": {"tags": ["INVT_DC_MJ_AKA"], "summary": "Query INVT_DC_MJ_AKA", "description": "GET rows from Data Lake table INVT_DC_MJ_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_INVT_DC_MJ_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/INVT_DC_MJ_CAT_VND_AKA": {"get": {"tags": ["INVT_DC_MJ_CAT_VND_AKA"], "summary": "Query INVT_DC_MJ_CAT_VND_AKA", "description": "GET rows from Data Lake table INVT_DC_MJ_CAT_VND_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_INVT_DC_MJ_CAT_VND_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/INVT_ST_MJ_CAT_AKA": {"get": {"tags": ["INVT_ST_MJ_CAT_AKA"], "summary": "Query INVT_ST_MJ_CAT_AKA", "description": "GET rows from Data Lake table INVT_ST_MJ_CAT_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_INVT_ST_MJ_CAT_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/INVT_ST_MJ_CAT_CLR_AKA": {"get": {"tags": ["INVT_ST_MJ_CAT_CLR_AKA"], "summary": "Query INVT_ST_MJ_CAT_CLR_AKA", "description": "GET rows from Data Lake table INVT_ST_MJ_CAT_CLR_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_INVT_ST_MJ_CAT_CLR_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/INVT_ST_MJ_CAT_FAB_AKA": {"get": {"tags": ["INVT_ST_MJ_CAT_FAB_AKA"], "summary": "Query INVT_ST_MJ_CAT_FAB_AKA", "description": "GET rows from Data Lake table INVT_ST_MJ_CAT_FAB_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_INVT_ST_MJ_CAT_FAB_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/INVT_ST_MJ_CAT_MACRO_MVGR_AKA": {"get": {"tags": ["INVT_ST_MJ_CAT_MACRO_MVGR_AKA"], "summary": "Query INVT_ST_MJ_CAT_MACRO_MVGR_AKA", "description": "GET rows from Data Lake table INVT_ST_MJ_CAT_MACRO_MVGR_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_INVT_ST_MJ_CAT_MACRO_MVGR_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/INVT_ST_MJ_CAT_MICRO_MVGR_AKA": {"get": {"tags": ["INVT_ST_MJ_CAT_MICRO_MVGR_AKA"], "summary": "Query INVT_ST_MJ_CAT_MICRO_MVGR_AKA", "description": "GET rows from Data Lake table INVT_ST_MJ_CAT_MICRO_MVGR_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_INVT_ST_MJ_CAT_MICRO_MVGR_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/INVT_ST_MJ_CAT_MRP_AKA": {"get": {"tags": ["INVT_ST_MJ_CAT_MRP_AKA"], "summary": "Query INVT_ST_MJ_CAT_MRP_AKA", "description": "GET rows from Data Lake table INVT_ST_MJ_CAT_MRP_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_INVT_ST_MJ_CAT_MRP_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/INVT_ST_MJ_CAT_RNG_SEG_AKA": {"get": {"tags": ["INVT_ST_MJ_CAT_RNG_SEG_AKA"], "summary": "Query INVT_ST_MJ_CAT_RNG_SEG_AKA", "description": "GET rows from Data Lake table INVT_ST_MJ_CAT_RNG_SEG_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_INVT_ST_MJ_CAT_RNG_SEG_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/INVT_ST_MJ_CAT_SIZE_AKA": {"get": {"tags": ["INVT_ST_MJ_CAT_SIZE_AKA"], "summary": "Query INVT_ST_MJ_CAT_SIZE_AKA", "description": "GET rows from Data Lake table INVT_ST_MJ_CAT_SIZE_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_INVT_ST_MJ_CAT_SIZE_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/INVT_ST_MJ_CAT_VND_AKA": {"get": {"tags": ["INVT_ST_MJ_CAT_VND_AKA"], "summary": "Query INVT_ST_MJ_CAT_VND_AKA", "description": "GET rows from Data Lake table INVT_ST_MJ_CAT_VND_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_INVT_ST_MJ_CAT_VND_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/Issue_Tracker": {"get": {"tags": ["Issue_Tracker"], "summary": "Query Issue_Tracker", "description": "GET rows from Data Lake table Issue_Tracker. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_Issue_Tracker", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/Karma_Detailed_Report": {"get": {"tags": ["Karma_Detailed_Report"], "summary": "Query Karma_Detailed_Report", "description": "GET rows from Data Lake table Karma_Detailed_Report. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_Karma_Detailed_Report", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/Karma_Summary_Report": {"get": {"tags": ["Karma_Summary_Report"], "summary": "Query Karma_Summary_Report", "description": "GET rows from Data Lake table Karma_Summary_Report. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_Karma_Summary_Report", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/L_ARTICLE_Sheet1": {"get": {"tags": ["L_ARTICLE_Sheet1"], "summary": "Query L_ARTICLE_Sheet1", "description": "GET rows from Data Lake table L_ARTICLE_Sheet1. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_L_ARTICLE_Sheet1", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/MRDC_VAR_ART_AKA": {"get": {"tags": ["MRDC_VAR_ART_AKA"], "summary": "Query MRDC_VAR_ART_AKA", "description": "GET rows from Data Lake table MRDC_VAR_ART_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_MRDC_VAR_ART_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/MSA_STOCK_DATA_AKA": {"get": {"tags": ["MSA_STOCK_DATA_AKA"], "summary": "Query MSA_STOCK_DATA_AKA", "description": "GET rows from Data Lake table MSA_STOCK_DATA_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_MSA_STOCK_DATA_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/PO_DATA_AKA": {"get": {"tags": ["PO_DATA_AKA"], "summary": "Query PO_DATA_AKA", "description": "GET rows from Data Lake table PO_DATA_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_PO_DATA_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/Product_Master": {"get": {"tags": ["Product_Master"], "summary": "Query Product_Master", "description": "GET rows from Data Lake table Product_Master. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_Product_Master", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/RETAIL_BAR_CODE_AKA": {"get": {"tags": ["RETAIL_BAR_CODE_AKA"], "summary": "Query RETAIL_BAR_CODE_AKA", "description": "GET rows from Data Lake table RETAIL_BAR_CODE_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_RETAIL_BAR_CODE_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ROI_TREND_DATA_AKA": {"get": {"tags": ["ROI_TREND_DATA_AKA"], "summary": "Query ROI_TREND_DATA_AKA", "description": "GET rows from Data Lake table ROI_TREND_DATA_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ROI_TREND_DATA_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/SALE_DATA_CM_AKA": {"get": {"tags": ["SALE_DATA_CM_AKA"], "summary": "Query SALE_DATA_CM_AKA", "description": "GET rows from Data Lake table SALE_DATA_CM_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_SALE_DATA_CM_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/SALE_DATA_L_2_YEAR_MONTH_AKA": {"get": {"tags": ["SALE_DATA_L_2_YEAR_MONTH_AKA"], "summary": "Query SALE_DATA_L_2_YEAR_MONTH_AKA", "description": "GET rows from Data Lake table SALE_DATA_L_2_YEAR_MONTH_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_SALE_DATA_L_2_YEAR_MONTH_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/STORE_MAJ_CAT_BUDGET_FIXTURE_AKA": {"get": {"tags": ["STORE_MAJ_CAT_BUDGET_FIXTURE_AKA"], "summary": "Query STORE_MAJ_CAT_BUDGET_FIXTURE_AKA", "description": "GET rows from Data Lake table STORE_MAJ_CAT_BUDGET_FIXTURE_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_STORE_MAJ_CAT_BUDGET_FIXTURE_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/STORE_PLANT_MASTER_AKA": {"get": {"tags": ["STORE_PLANT_MASTER_AKA"], "summary": "Query STORE_PLANT_MASTER_AKA", "description": "GET rows from Data Lake table STORE_PLANT_MASTER_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_STORE_PLANT_MASTER_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/Sale_Data_L_2Years_MAJ_CAT_aka": {"get": {"tags": ["Sale_Data_L_2Years_MAJ_CAT_aka"], "summary": "Query Sale_Data_L_2Years_MAJ_CAT_aka", "description": "GET rows from Data Lake table Sale_Data_L_2Years_MAJ_CAT_aka. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_Sale_Data_L_2Years_MAJ_CAT_aka", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/Sale_Data_L_2Years_STORE_aka": {"get": {"tags": ["Sale_Data_L_2Years_STORE_aka"], "summary": "Query Sale_Data_L_2Years_STORE_aka", "description": "GET rows from Data Lake table Sale_Data_L_2Years_STORE_aka. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_Sale_Data_L_2Years_STORE_aka", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/TBL_16_RETAIL_GND_BGT_FORMAT_Sheet1": {"get": {"tags": ["TBL_16_RETAIL_GND_BGT_FORMAT_Sheet1"], "summary": "Query TBL_16_RETAIL_GND_BGT_FORMAT_Sheet1", "description": "GET rows from Data Lake table TBL_16_RETAIL_GND_BGT_FORMAT_Sheet1. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_TBL_16_RETAIL_GND_BGT_FORMAT_Sheet1", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/TNA_REPORT": {"get": {"tags": ["TNA_REPORT"], "summary": "Query TNA_REPORT", "description": "GET rows from Data Lake table TNA_REPORT. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_TNA_REPORT", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/Task_Tracker": {"get": {"tags": ["Task_Tracker"], "summary": "Query Task_Tracker", "description": "GET rows from Data Lake table Task_Tracker. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_Task_Tracker", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/VIEW_SALE_GEN_CLR_ART_WISE": {"get": {"tags": ["VIEW_SALE_GEN_CLR_ART_WISE"], "summary": "Query VIEW_SALE_GEN_CLR_ART_WISE", "description": "GET rows from Data Lake table VIEW_SALE_GEN_CLR_ART_WISE. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_VIEW_SALE_GEN_CLR_ART_WISE", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/VW_ET_SALES_DATA_AKA": {"get": {"tags": ["VW_ET_SALES_DATA_AKA"], "summary": "Query VW_ET_SALES_DATA_AKA", "description": "GET rows from Data Lake table VW_ET_SALES_DATA_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_VW_ET_SALES_DATA_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/VW_GRC_REPORT_AKA": {"get": {"tags": ["VW_GRC_REPORT_AKA"], "summary": "Query VW_GRC_REPORT_AKA", "description": "GET rows from Data Lake table VW_GRC_REPORT_AKA. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_VW_GRC_REPORT_AKA", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/VW_GRC_REPORT_NEW": {"get": {"tags": ["VW_GRC_REPORT_NEW"], "summary": "Query VW_GRC_REPORT_NEW", "description": "GET rows from Data Lake table VW_GRC_REPORT_NEW. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_VW_GRC_REPORT_NEW", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/VW_LYSP_DAY_MAPPING": {"get": {"tags": ["VW_LYSP_DAY_MAPPING"], "summary": "Query VW_LYSP_DAY_MAPPING", "description": "GET rows from Data Lake table VW_LYSP_DAY_MAPPING. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_VW_LYSP_DAY_MAPPING", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ZSRM_VEND_PAYMENT_INFO": {"get": {"tags": ["ZSRM_VEND_PAYMENT_INFO"], "summary": "Query ZSRM_VEND_PAYMENT_INFO", "description": "GET rows from Data Lake table ZSRM_VEND_PAYMENT_INFO. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ZSRM_VEND_PAYMENT_INFO", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/vw_PO_PENDING_New": {"get": {"tags": ["vw_PO_PENDING_New"], "summary": "Query vw_PO_PENDING_New", "description": "GET rows from Data Lake table vw_PO_PENDING_New. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_vw_PO_PENDING_New", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ET_ZGET_STORE_MASTER": {"get": {"tags": ["ET_ZGET_STORE_MASTER"], "summary": "Query ET_ZGET_STORE_MASTER", "description": "GET rows from Data Lake table ET_ZGET_STORE_MASTER. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ET_ZGET_STORE_MASTER", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ET_ZTEST": {"get": {"tags": ["ET_ZTEST"], "summary": "Query ET_ZTEST", "description": "GET rows from Data Lake table ET_ZTEST. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ET_ZTEST", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ET_PROJECT_OVERVIEW": {"get": {"tags": ["ET_PROJECT_OVERVIEW"], "summary": "Query ET_PROJECT_OVERVIEW", "description": "GET rows from Data Lake table ET_PROJECT_OVERVIEW. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ET_PROJECT_OVERVIEW", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ET_FINANCE_DOCUMENTS": {"get": {"tags": ["ET_FINANCE_DOCUMENTS"], "summary": "Query ET_FINANCE_DOCUMENTS", "description": "GET rows from Data Lake table ET_FINANCE_DOCUMENTS. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ET_FINANCE_DOCUMENTS", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ET_ZADVANCE_PAYMENT": {"get": {"tags": ["ET_ZADVANCE_PAYMENT"], "summary": "Query ET_ZADVANCE_PAYMENT", "description": "GET rows from Data Lake table ET_ZADVANCE_PAYMENT. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ET_ZADVANCE_PAYMENT", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ET_ADVANCE_PAYMENT": {"get": {"tags": ["ET_ADVANCE_PAYMENT"], "summary": "Query ET_ADVANCE_PAYMENT", "description": "GET rows from Data Lake table ET_ADVANCE_PAYMENT. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ET_ADVANCE_PAYMENT", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}, "/api/ET_GENERATED": {"get": {"tags": ["ET_GENERATED"], "summary": "Query ET_GENERATED", "description": "GET rows from Data Lake table ET_GENERATED. Supports OData: \`$filter\`, \`$orderby\`, \`$top\`, \`$skip\`, \`$select\`.", "operationId": "get_ET_GENERATED", "parameters": [{"name": "$filter", "in": "query", "schema": {"type": "string"}, "description": "OData filter e.g. \`PLANT eq 'DC01'\`"}, {"name": "$orderby", "in": "query", "schema": {"type": "string"}, "description": "Order by field e.g. \`POSTING_DATE desc\`"}, {"name": "$top", "in": "query", "schema": {"type": "integer", "default": 100}, "description": "Limit rows (default 100)"}, {"name": "$skip", "in": "query", "schema": {"type": "integer"}, "description": "Skip rows for pagination"}, {"name": "$select", "in": "query", "schema": {"type": "string"}, "description": "Comma-separated columns e.g. \`VENDOR,AMOUNT\`"}], "responses": {"200": {"description": "Success \u2014 returns value array with rows"}, "400": {"description": "Bad filter syntax"}}}}}};
    ...
    window.onload = function() {
      SwaggerUIBundle({
        ...
        requestInterceptor: (req) => {
          // Strip the worker prefix — calls go directly to DAB
          return req;
        }
      });
    };

    function filterAPIs(val) {
      // Use built-in swagger-ui filter
